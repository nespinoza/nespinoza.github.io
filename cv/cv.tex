...
300,000+ USD awarded to co-I Espinoza to lead the Roman Transiting Exoplanet Atmospheric Characterization WG (PI: Quintana)
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill 2023B --- present
...
\item  {\color{cobalt}{Wang \& \textbf{Espinoza}: \textit{A Blind Search for Transit Depth Variability with TESS}, The Astronomical Journal (2023), in press.}}
...
\textbf{Selected co-authored publications} (full list of 160+ papers in \href{https://ui.adsabs.harvard.edu/public-libraries/JAL40dT5ToGup2Omjvc3Ag}{ADS}; h-index: 38):
\begin{itemize}
\setlength\itemsep{0.05cm}

\item Grant, Lewis, Wakeford et al. (including \textbf{Espinoza}): \textit{JWST-TST DREAMS: Quartz Clouds in the Atmosphere of WASP-17b},  The Astrophysical Journal Letters (2023), 956, L29.
\item Radica, Welbanks, \textbf{Espinoza}, et al.: \textit{Awesome SOSS: transmission spectroscopy of WASP-96b with NIRISS/SOSS}, Monthly Notices of the Royal Astronomical Society (2023), vol. 524, 835.
\item Dos Santos, Alam, \textbf{Espinoza}, et al.: \textit{Observing Atmospheric Escape in Sub-Jovian Worlds with JWST}, The Astronomical Journal (2023), 165, 6.
\item The JWST Transiting Exoplanet Community Early Release Science Team (including \textbf{Espinoza}): \textit{Identification of carbon dioxide in an exoplanet atmosphere}, Nature (2023), vol. 614, 649.
\item Schlawin, Beatty, Brooks et al. (including \textbf{Espinoza}): \textit{JWST NIRCam Defocused Imaging: Photometric Stability Performance and How it Can Sense Mirror Tilts}, Publications of the Astronomical Society of the Pacific (2023), vol. 135, 1043.
