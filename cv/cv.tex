...
Joint position between the Max-Planck-Institut f\"ur Astronomie and the University of Bern.
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill 2017---present
...
\item Brahm, \textbf{Espinoza}, Jord\'an, et al.: \textit{EPIC247098361b: a transiting warm Saturn on an eccentric $P=11.2$ days orbit around a $V=9.9$ star}, Monthly Notices of the Royal Astronomical Society (2018), in press.
...
\item \textbf{Espinoza} and Jord\'an: \textit{Limb darkening and exoplanets - II. Choosing the best law for optimal retrieval of transit parameters}, Monthly Notices of the Royal Astronomical Society (2016), vol. 457, 3573.
\item \textbf{Espinoza} and Jord\'an: \textit{Limb darkening and exoplanets: testing stellar model atmospheres and identifying biases in transit parameters}, Monthly Notices of the Royal Astronomical Society (2015), vol. 450, 1879.
...
\begin{enumerate}
\setlength\itemsep{0.05cm}
\item Jones, Brahm, \textbf{Espinoza} et al.: \textit{A hot Saturn on an eccentric orbit around the giant star EPIC228754001},  Astronomy \& Astrophysics (2018), in press.
...
\end{flushleft}
\begin{minipage}[t]{0.6\textwidth}
\ \ \ \ \ Jennifer Fienco (Undergraduate student), PUC

\ \ \ \ \ Project: ``Equilibrium Chemistry in the presence of TiO"
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\hfill 2017---present
\end{minipage}\\
