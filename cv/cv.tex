...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
\textbf{First and second author} (postdoc/student/mentee-led marked in {\color{cobalt}{\textbf{blue}}}) publications follow below. \textbf{Full list of 190+ refereed co-authored publications can be found in \href{https://ui.adsabs.harvard.edu/public-libraries/JAL40dT5ToGup2Omjvc3Ag}{ADS}; h-index: 49)}:
\begin{enumerate}
\setlength\itemsep{0.05cm}

\item  {\color{cobalt}{Gressier, \textbf{Espinoza}, Allen et al.: \textit{Hints of a Sulfur-rich Atmosphere around the 1.6 REarth Super-Earth L98-59 d from JWST NIRspec G395H Transmission Spectroscopy}, Astrophysical Journal Letters (2024), vol. 975, 10.}}
