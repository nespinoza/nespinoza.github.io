...
\textbf{Associate Astronomer with Tenure}\\
...
As PI or co-PI (total: 800,000+ USD):\\
...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
\textbf{Using stellar contamination proxy TRAPPIST-1 b to search for an atmosphere on TRAPPIST-1 e}\\
130 hours of telescope time (over Cycles 3 and 4; co-PI with Allen).\\
...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
\textbf{Hot Jupiter Atmospheric Forecast: are mornings cloudier than evenings in other worlds?}\\
61.6 hours of telescope time (co-PI with Powell).\\
James Webb Space Telescope (JWST).\\
Program ID: GO 3969.
\end{flushleft}
\end{minipage}
...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
\textbf{First and second author} (postdoc/student/mentee-led marked in {\color{cobalt}{\textbf{blue}}}) publications follow below. \textbf{Full list of 200+ refereed co-authored publications can be found in \href{https://ui.adsabs.harvard.edu/public-libraries/JAL40dT5ToGup2Omjvc3Ag}{ADS}; h-index: 50)}:
\begin{enumerate}
\setlength\itemsep{0.05cm}

{\color{cobalt}{\item Allen, \textbf{Espinoza}, Diamond-Lowe, et al.: "\textit{Hot Rocks Survey. IV. Emission from LTT 3780 b Is Consistent with a Bare Rock}." \textit{Astronomical Journal} (2025), vol. 170, no. 4, pp. 240}}
\item \textbf{Espinoza}, Allen, Glidden, et al.: "\textit{JWST-TST DREAMS: NIRSpec/PRISM Transmission Spectroscopy of the Habitable Zone Planet TRAPPIST-1 e}." \textit{Astrophysical Journal Letters} (2025), vol. 990, no. 2, pp. L52
\item \textbf{Espinoza} \& Perrin: "\textit{Highlights from Exoplanet Observations by the James Webb Space Telescope}." Review Chapter for the Handbook of Exoplanets, 2nd Edition, Hans Deeg and Juan Antonio Belmonte (Eds. in Chief), Springer International Publishing AG, part of Springer Nature (2025). Available as \textit{arXiv e-print}, 2025, pp. arXiv:2505.20520
{\color{cobalt}{\item  {\color{cobalt}{Gressier, \textbf{Espinoza}, Allen et al.: \textit{Hints of a Sulfur-rich Atmosphere around the 1.6 REarth Super-Earth L98-59 d from JWST NIRspec G395H Transmission Spectroscopy}, Astrophysical Journal Letters (2024), vol. 975, 10.}}}}
\item  {\color{cobalt}{Baines, \textbf{Espinoza}, Filippazzo et al.: \textit{JWST NIRISS/SOSS: advancements in calibration and observational tools for exoplanetary science}, SPIE (2024), vol. 1309, 12.}}
\item \textbf{Espinoza}, Steinrueck, Kirk et al.: \textit{Inhomogeneous terminators on the exoplanet WASP-39 b}, Nature (2024), vol. 632, 1017.
\item  {\color{cobalt}{Deal \& \textbf{Espinoza}: \textit{Spelunker: A quick-look Python pipeline for JWST NIRISS FGS Guide Star Data}, Journal of Open Source Software (2024), vol. 9, 6202.}}
\item  {\color{cobalt}{Wang \& \textbf{Espinoza}: \textit{A Blind Search for Transit Depth Variability with TESS}, The Astronomical Journal (2024), vol. 167, 1.}}
...
\item  {\color{cobalt}{Allen, \textbf{Espinoza}, Jord\'an: \textit{ACCESS: Tentative Detection of H2O in the Ground-based Optical Transmission Spectrum of the Low-density Hot Saturn HATS-5b}, The Astronomical Journal (2022), vol. 164, 153.}}
