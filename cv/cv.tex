...
Up to 40,000 USD allocated to the project ``Towards Constraints On Morning And Evening Terminators Of Distant Worlds With TESS" (PI: Espinoza).
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill 2020B --- present
...
\begin{enumerate}
\setlength\itemsep{0.05cm}
\item Carleo, Gandolfi, Barrag\'an et al. (including \textbf{Espinoza}): \textit{The Multiplanet System TOI-421}, The Astronomical Journal (2020), 160, 114. 
\item Nowak, Palle, Gandolfi, et al. (including \textbf{Espinoza}): \textit{K2-280 b - a low density warm sub-Saturn around a mildly evolved star}, Monthly Notices of the Royal Astronomical Society (2020), 497, 4423. 
\item Gill, Wheatley, Cooke et al. (including \textbf{Espinoza}): \textit{NGTS-11 b (TOI-1847 b): A Transiting Warm Saturn Recovered from a TESS Single-transit Event}, The Astrophysical Journal Letters (2020), 898, 11. 
\item Carmichael, Quinn, Mustill et al. (including \textbf{Espinoza}): \textit{Two Intermediate-mass Transiting Brown Dwarfs from the TESS Mission}, The Astronomical Journal (2020), 160, 53. 
...
\item Nielsen, Brahm, Bouchy et al. (including \textbf{Espinoza}): \textit{Three short-period Jupiters from TESS. HIP 65Ab, TOI-157b, and TOI-169b}, Astronomy \& Astrophysics (2020), 639, 76. 
\item Bakos, Bayliss, Bento et al. (including \textbf{Espinoza}): \textit{HATS-71b: A Giant Planet Transiting an M3 Dwarf Star in TESS Sector 1}, The Astronomical Journal (2020), 159, 267. 
...
\item Gibbs, Bixel, Rackham, et al. (including \textbf{Espinoza}): \textit{EDEN: Sensitivity Analysis and Transiting Planet Detection Limits for Nearby Late Red Dwarfs}, The Astronomical Journal (2020), 159, 4. 
\item Hartman, Jord\'an, Bayliss, et al. (including \textbf{Espinoza}): \textit{HATS-47b, HATS-48Ab, HATS-49b, and HATS-72b: Four Warm Giant Planets Transiting K Dwarfs}, The Astronomical Journal (2020), 159, 4. 
\item Stock, Kemmer, Reffert, et al. (including \textbf{Espinoza}): \textit{The CARMENES search for exoplanets around M dwarfs. Characterization of the nearby ultra-compact multiplanetary system YZ Ceti}, Astronomy \& Astrophysics (2020), 636, A119. 
\item Astudillo-Defru, Cloutier, Wang et al. (including \textbf{Espinoza}): \textit{A hot terrestrial planet orbiting the bright M dwarf L 168-9 unveiled by TESS}, Astronomy \& Astrophysics (2020), 636, A58.
...
\item Lendl, Bouchy, Gill, et al. (including \textbf{Espinoza}): \textit{TOI-222: a single-transit TESS candidate revealed to be a 34-d eclipsing binary with CORALIE, EulerCam, and NGTS}, Monthly Notices of the Royal Astronomical Society (2020), 492, 1761. 
\item Petigura, Livingston, Batygin, et al. (including \textbf{Espinoza}): \textit{K2-19b and c are in a 3:2 Commensurability but out of Resonance: A Challenge to Planet Assembly by Convergent Migration}, The Astronomical Journal (2020), 159, 2. 
\item Mancini, Sarkis, Henning, et al. (including \textbf{Espinoza}): \textit{The highly inflated giant planet WASP-174b}, Astronomy \& Astrophysics (2020), 633, 30.
\item Kirk, L\'opez-Morales, Wheatley, et al. (including \textbf{Espinoza}): \textit{LRG-BEASTS: Transmission Spectroscopy and Retrieval Analysis of the Highly Inflated Saturn-mass Planet WASP-39b}, The Astronomical Journal (2019), 158, 144.
...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
Weekly astronomy show on chilean national radio station ``Radio USACH"
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill present
...
\begin{flushleft}%
  \setlength{\leftskip}{0.2cm}%
Public Lecture as part of the STScI ``Public Lecture Series", STScI, Baltimore, USA
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill 03/2020
...
Project: ``Precise transit spectroscopy from the ground with the Large Binocular Telescope" | Institution: John Hopkins University.
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\hfill 2020B --- present
